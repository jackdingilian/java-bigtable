 ...
 *   }
 *   if p.batch_complete and `buffer` is not empty {
...
public final class PartialResultSet extends com.google.protobuf.GeneratedMessageV3
  ...
  public static final int BATCH_COMPLETE_FIELD_NUMBER = 6;
  private boolean batchComplete_ = false;
  /**
   *
   *
   * <pre>
   * If true, the buffered data from `partial_rows` forms a complete parseable
   * message of the appropriate type.
   *
   ...
   * last one, this field is guaranteed to be true. In other words, clients may
   * assume that a batch will never cross a `result_token` boundary.
   * </pre>
   *
   * <code>bool batch_complete = 6;</code>
   *
   * @return The batchComplete.
   */
  @java.lang.Override
  public boolean getBatchComplete() {
    return batchComplete_;
  }
   ...
   * ongoing result batch, or `batch_complete` is also true.
   *
   ...
   * after a `batch_complete` message, and any time `reset` is true.
   *
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (batchComplete_ != false) {
      output.writeBool(6, batchComplete_);
    }
    if (reset_ != false) {
  ...
  public int getSerializedSize() {
    ...
    if (batchComplete_ != false) {
      size += com.google.protobuf.CodedOutputStream.computeBoolSize(6, batchComplete_);
    }
    if (reset_ != false) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getBatchComplete() != other.getBatchComplete()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + BATCH_COMPLETE_FIELD_NUMBER;
    hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getBatchComplete());
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    private void buildPartial0(com.google.bigtable.v2.PartialResultSet result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.batchComplete_ = batchComplete_;
      }
    ...
    public Builder mergeFrom(com.google.bigtable.v2.PartialResultSet other) {
      ...
      if (other.getBatchComplete() != false) {
        setBatchComplete(other.getBatchComplete());
      }
    ...
    private boolean batchComplete_;
    /**
     *
     *
     * <pre>
     ...
     * <code>bool batch_complete = 6;</code>
     *
     * @param value The batchComplete to set.
     * @return This builder for chaining.
     */
    public Builder setBatchComplete(boolean value) {

      batchComplete_ = value;
      bitField0_ |= 0x00000002;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder clearBatchComplete() {
