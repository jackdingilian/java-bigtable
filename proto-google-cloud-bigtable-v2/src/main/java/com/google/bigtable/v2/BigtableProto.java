  ...
  static {
    java.lang.String[] descriptorData = {
      "\n!google/bigtable/v2/bigtable.proto\022\022goo"
          ...
          + "igtable.v2.ReadRowsResponse\"\350\002\332A\ntable_n"
          ...
          + "*/authorizedViews/*}:readRows:\001*\212\323\344\223\002\227\001\022"
          ...
          + "cts/*/instances/*/tables/*}/**0\001\022\325\003\n\rSam"
          + "pleRowKeys\022(.google.bigtable.v2.SampleRo"
          + "wKeysRequest\032).google.bigtable.v2.Sample"
          + "RowKeysResponse\"\354\002\332A\ntable_name\332A\031table_"
          + "name,app_profile_id\202\323\344\223\002\236\001\022>/v2/{table_n"
          + "ame=projects/*/instances/*/tables/*}:sam"
          + "pleRowKeysZ\\\022Z/v2/{authorized_view_name="
          + "projects/*/instances/*/tables/*/authoriz"
          + "edViews/*}:sampleRowKeys\212\323\344\223\002\227\001\022:\n\ntable"
          + "_name\022,{table_name=projects/*/instances/"
          + "*/tables/*}\022\020\n\016app_profile_id\022G\n\024authori"
          + "zed_view_name\022/{table_name=projects/*/in"
          + "stances/*/tables/*}/**0\001\022\351\003\n\tMutateRow\022$"
          ...
          + "is.com/auth/cloud-platform.read-onlyB\364\003\n"
          ...
          + "e::Cloud::Bigtable::V2\352AP\n%bigtableadmin"
          + ".googleapis.com/Instance\022\'projects/{proj"
          + "ect}/instances/{instance}\352A\\\n\"bigtablead"
          + "min.googleapis.com/Table\0226projects/{proj"
          + "ect}/instances/{instance}/tables/{table}"
          + "\352A\207\001\n+bigtableadmin.googleapis.com/Autho"
          + "rizedView\022Xprojects/{project}/instances/"
          + "{instance}/tables/{table}/authorizedView"
          + "s/{authorized_view}b\006proto3"
    };
    descriptor =
